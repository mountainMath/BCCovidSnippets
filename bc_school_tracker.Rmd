...
ggplot(aes(x=week,y=share,fill=`Health Authority`)) +
  ...
  scale_fill_manual(values=ha_colours,guide='none') +
...
g <- ggplot(m) +
  ...
  scale_fill_viridis_c(guide='none',option="magma",limits=c(0,30000)) +
  scale_alpha_continuous(guide='none',limits=c(0,30000)) +
  geom_roads() +
  geom_water(color="grey",size=0.1) +
  geom_sf(data=school_data,size=0.1,alpha=0.4) +
  geom_sf(fill=NA,color="brown",size=0.1) +
