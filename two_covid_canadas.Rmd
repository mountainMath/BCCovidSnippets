...
date: "Last updated at `r format(Sys.time(), '%d %B, %Y - %H:%M')`"
...
#ggsave("~/Desktop/two_covid_canadas.png",width=7,height=5)
#ggsave("~/Desktop/two_covid_canadas.svg",width=7,height=5)
