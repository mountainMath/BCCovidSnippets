...
A fairly simple trend line model like a (multiplicative) STL decomposition can ectract cleaner trend lines that also cover the most recent 3 days of data, at the expense of a bit of added volatility at the very end of the trend line where the trend line may shift slightly when new data comes in. 
