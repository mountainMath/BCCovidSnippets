...
if (FALSE) {
  n501y <- googlesheets4::read_sheet("https://docs.google.com/spreadsheets/d/1V-879v4snL2hAUJR2U4UKSrieQr18egUNrbyJvjEj_I/edit#gid=706339432","Newest")
  write_csv(n501y,here::here("data/n501y.csv"))
}
...
n501y <- read_csv(here::here("data/n501y.csv")) %>%
  mutate(Date=as.Date(Date)+4,
         ratio_voc=share_to_ratio(share_voc))
