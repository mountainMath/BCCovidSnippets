...
graph_to_s3(g,"bccovid","open_table_canada_cities.png",width=knitr::opts_chunk$get('fig.width'),height=knitr::opts_chunk$get('fig.height'))
```
...
graph_to_s3(g,"bccovid","open_table_canada_cities-2.png",width=knitr::opts_chunk$get('fig.width'),height=knitr::opts_chunk$get('fig.height'))
```
